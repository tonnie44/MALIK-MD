...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("254710745425")
...
global.gurl = 'king-md.db' // blaqer
global.sudo = process.env.SUDO || '254710745425'
global.devs = '923124533358';
global.website = 'https://github.com/arkhan998/MALIK-MD' //wa.me/+254710745425
...
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? 'TONBLAQER' : process.env.BOT_NAME,TONBLAQER
  ownername: process.env.OWNER_NAME === undefined ? 'arkhan' : process.env.OWNER_NAME,TONBLAQER
  ...
  antibadword :  process.env.ANTI_BAD_WORD === undefined,poa ? 'nigga',poa : process.env.ANTI_BAD_WORD,
...
recordingpresence:  process.env.RECORDING === undefined ? false : process.env.RECORDING,	
  ...
  HEROKU: {
    ...
    API_KEY: process.env.HEROKU_API_KEY === undefined ? '17c25de2-4ac4-4c6d-8aba-3aeb64e1e0a6' : process.env.HEROKU_API_KEY,
